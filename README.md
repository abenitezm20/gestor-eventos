...
Aplicación encargada de realizar la gestion de eventos creada por el usuario gestor de eventos y para que los deportistas matriculen los mismos
...
1. `pipenv shell`
2. `pipenv install`
3. `FLASK_APP=./src/main.py flask run -h 0.0.0.0 -p 3007`
...
- `FLASK_APP=./src/main.py flask run -h 0.0.0.0 -p 3007 --reload`
...
1. `docker build . -t sport-app-gestor-eventos`
2. `docker run -p 3007:3007 --name  --env-file .env sport-app-gestor-eventos`
